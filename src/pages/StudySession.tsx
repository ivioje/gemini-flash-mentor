...
export default function StudySession() {
  ...
  return (
    <MainLayout>
      <div className="mb-6">
        <Link to={`/sets/${id}`} className="text-muted-foreground hover:text-foreground flex items-center mb-4">
        ...
        {!isSessionComplete ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="mb-6 text-muted-foreground">
              You've completed all {flashcards.length} cards in this study session.
            </p>
