...
// Flashcard sets
export const getFlashcardSets = async (userId: string): Promise<FlashcardSet[]> => {
  try {
    const q = query(
...
export const getFlashcardSetById = async (id: string): Promise<FlashcardSet> => {
  try {
...
// Study sessions
export const saveStudySession = async (studyData: any): Promise<string> => {
  try {
...
export const getUserStudyStats = async (userId: string): Promise<any[]> => {
  try {
    const q = query(
